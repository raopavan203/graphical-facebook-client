...
function NewsFeeds(person){                                             //News feeds Object
    ...
    this.miniView = function(postNumber){
        if(!that.infoAvailable){
            ...
            var feed = that.newsFeed[postNumber];
            var content = "<a href='https://www.facebook.com/" + feed.from.id + "'>  <h2>" + 
                            (typeof feed.story !== 'undefined' ? feed.story : feed.from.name) + "</h2></a> ";
            ...
            if(typeof feed.withTags !== 'undefined'){
                content +="with ";
                for(var i=0;i<feed.withTags.length ; i++){
            ...
            if(typeof feed.to !== 'undefined' && typeof feed.withTags === 'undefined'){
                content += "To ";
                for(var i=0;i<feed.to.length;i++)
            ...
            content += feed.message !== 'undefined' ? feed.message + "<p>" : "";
            ...
            if(typeof feed.picture !== 'undefined')
                content += "<img width='400' src='" + feed.picture + "'/>";
                
            if(typeof feed.caption !== 'undefined')
                content += "<div class ='newContentCaption'>" + feed.caption + "</div>";
                
            content += "</div><div class='newsContentDescription'>";
            ...
            if(typeof feed.time !== 'undefined')
                content +="<div class='newsContentTime'>" + feed.time + "</div>";
            
            content +="<div class='newsContentActionBar'>";
            ...
            content += "<div class='newsContentComments'>";
            
            if(typeof feed.comments !== 'undefined')
                for(var i=0;i<feed.comments.length;i++)
                    content += "<div class='newsComment'>" + feed.comments[i].from + "<p>" + feed.comments[i].message + "<p>" + feed.comments[i].time + "</div>";
